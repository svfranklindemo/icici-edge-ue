...
const btn = document.getElementById('apply-now');
...
// Form Button/Events
const screen1 = document.getElementsByClassName('form-screen-1')[0];
const screen2 = document.getElementsByClassName('form-screen-2')[0];
const screen3 = document.getElementsByClassName('form-screen-3')[0];
...
submitBtn.onclick = function () {
  ...
  const elements = document.getElementsByClassName('formVal');
  const formData = new FormData();
  // eslint-disable-next-line no-plusplus
  for (let i = 0; i < elements.length; i++) { formData.append(elements[i].name, elements[i].value); }
